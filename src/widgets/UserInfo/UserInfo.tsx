  ...
  return (
    <article className={`widgets flex gap-8 p-8 ${className}`}>
      <div className="flex w-1/2 flex-col">
        <Typography value="Петров Константин Александрович" size="title" />
      ...
      <div className="flex w-1/2 flex-col">
        ...
        <Typography
          ...
          className="mt-10"
        />
        <Typography size="title" value="250 ₽" className="my-3 font-semibold" />
