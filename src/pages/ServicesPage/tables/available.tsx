...
const row = (
  <tr>
    ...
    <th className="py-7 pr-8">
      <button className="rounded-md bg-blue-700 px-3 py-2 text-sm text-white">
        Подключить
      </button>
    </th>
  </tr>
...
export const availableFree = (
  <div className="flex flex-col gap-5" key={nanoid()}>
    <Accordeon title="Мобильный интернет 5" amountChildren={1}>
...
export const availablePaid = (
  <div className="flex flex-col gap-5" key={nanoid()}>
    <Accordeon title="SMS/MMS" amountChildren={1}>
      <table className="border-collapse">
        {thead}
        <tbody>{row}</tbody>
      </table>
